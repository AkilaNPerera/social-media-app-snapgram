...
const SignupForm = () => {
  ...
  const form = useForm<z.infer<typeof SignUpValidation>>({
    ...
    /*zod resolver integrates zod validation with React Hook Form. 
    When a user submits or interacts with the form, zodResolver validates the inputs using the Zod schema.*/
